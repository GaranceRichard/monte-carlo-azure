...
## 7.1 — Modèle cible des dépendances internes formalisé
...
## 7.2 — Directions de dépendance contrôlées automatiquement
...
## 7.10 — Contrats de communication inter-modules définis
...
## 7.11 — Composition root et injection explicite des adaptateurs opérationnels
...
## 7.12 — Contrats des ports et adaptateurs démontrés
...
## 7.13 — Horloge et générateurs d’identifiants techniques injectables
...
## 7.9 — Frontière d’identité structurelle et contractuelle
