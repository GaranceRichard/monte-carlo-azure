...
| [`dependency-authority.md`](dependency-authority.md) | Développeurs, architectes, qualité | Format, diagnostics, indépendance du domaine, API publiques et acyclicité des modules gouvernés | Contrat |
