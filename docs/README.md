...
| Checkpoints, périmètre, retour ciblé et engagement au push | Contributeurs | [`contribution-cycle.md`](contribution-cycle.md) | Procédure du cycle local proportionné | Gouvernance |
...
| [`dependency-authority.md`](dependency-authority.md) | Développeurs, architectes, qualité | Format, diagnostics, indépendance du domaine, API publiques, acyclicité et confinement des DTO techniques | Contrat |
...
| [`contribution-cycle.md`](contribution-cycle.md) | Contributeurs | Séparation normative entre checkpoint, contrôle de périmètre, retour ciblé et publication | Gouvernance |
...
- [`dependency-authority.md`](dependency-authority.md) — format versionné, liaison aux décisions 7.7/7.8,
  refus localisé des technologies dans le domaine, des imports profonds et des cycles de modules gouvernés ;
