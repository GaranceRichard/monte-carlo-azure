...
| T-08 | SD-09 + contexte + `FrontendClock` → SD-11 → SD-12 | `simulationForecastCore` lit un instant, le réutilise pour le timestamp et l’identité de repli, puis les mappers de stockage sérialisent, migrent les anciennes durées et refusent les résultats invalides. |
