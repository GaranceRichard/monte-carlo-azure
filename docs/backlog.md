...
**Feature en cours :** Feature 2 — Garantir la fiabilité du cœur statistique — 19/21 PBI réalisés (90,48 %).
**Prochain PBI :** `2.20` — Dérives de version et décisions de compatibilité statistique bloquées — non commencé.
**Reliquats de la Feature 2 :** `2.20`, `2.21`.
**Progression globale :** 30/141 PBI réalisés (21,28 %) ; 111 restants.

| Feature | Nombre de PBI | Réalisés | Restants |
| ---: | ---: | :---: | :---: |
| 1 — Disposer d’un système de preuve qualité gouverné | 11 | 11 | 0 |
| 2 — Garantir la fiabilité du cœur statistique | 21 | 19 | 2 |
