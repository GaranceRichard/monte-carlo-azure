  ...
  it("renders loading, sample stats and weeks result label", () => {
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        result: { resultKind: "weeks", seed: 1 },
    ...
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        result: {
          ...
          seed: 3,
          riskScore: 0.01,
          throughputReliability: { cv: 0.42, iqrRatio: 0.3, slopeNorm: -0.02, label: "incertain", samplesCount: 10 },
        },
  ...
  it("falls back to computed risk score when percentiles are incomplete and API score is missing", () => {
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        sampleStats: null,
        throughputData: [],
        result: { resultKind: "weeks", seed: 6 },
        displayPercentiles: { P70: 10 },
        simulationHistory: [],
        applyHistoryEntry: vi.fn(),
        clearSimulationHistory: vi.fn(),
  ...
  it("falls back to frontend reliability computation when API reliability is missing", () => {
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        result: { resultKind: "weeks", seed: 7, riskScore: 0.2 },
    ...
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        result: {
          ...
          seed: 8,
          riskScore: 0.9,
          throughputReliability: { cv: 1.2, iqrRatio: 1.1, slopeNorm: 0.01, label: "fragile", samplesCount: 12 },
        },
  ...
  it("closes the diagnostic modal as soon as the displayed result is invalidated", () => {
    const contextValue: { selectedTeam: string; simulation: Record<string, unknown> } = {
      ...
      simulation: {
        ...
        result: { resultKind: "weeks", seed: 16 },
    ...
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        result: {
          ...
          seed: 11,
          riskScore: 0.1,
          throughputReliability: { cv: 0.1, iqrRatio: 0.1, slopeNorm: 0.01, label: "fiable", samplesCount: 6 },
        },
        displayPercentiles: { P50: 10, P70: 12, P90: 14 },
        simulationHistory: [],
        applyHistoryEntry: vi.fn(),
  ...
  it("shows blocking diagnostics when data and required percentiles are missing", () => {
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        result: { resultKind: "weeks", seed: 12 },
    ...
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        result: {
          ...
          seed: 13,
          riskScore: 0.8,
          throughputReliability: { cv: 1, iqrRatio: 1, slopeNorm: 0.1, label: "fragile", samplesCount: 6 },
        },
        displayPercentiles: { P50: 10, P70: 14, P90: 20 },
        simulationHistory: [],
        applyHistoryEntry: vi.fn(),
  ...
  it("keeps incomplete legacy histories unchanged by hiding the diagnostic", () => {
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        sampleStats: null,
        throughputData: [],
        result: { resultKind: "weeks", seed: 14 },
        displayPercentiles: { P50: 10 },
        simulationHistory: [],
        applyHistoryEntry: vi.fn(),
        clearSimulationHistory: vi.fn(),
    ...
    vi.mocked(useSimulationContext).mockReturnValue({
      ...
      simulation: {
        ...
        result: {
          resultKind: "weeks",
          seed: 9,
          resultPercentiles: { P50: 12 },
          resultDistribution: [{ x: 12, count: 4 }],
          completionSummary: {
            completedCount: 4,
            censoredCount: 6,
            censoredRate: 0.6,
