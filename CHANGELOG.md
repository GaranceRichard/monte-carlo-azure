...
- migration du throughput, du Cycle Time et des semaines corrélées portefeuille vers cette API publique
  unique ;
- retrait des calculs locaux concurrents de rattachement et de regroupement hebdomadaire ;
